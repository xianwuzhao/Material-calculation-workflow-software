...
class RELAX(wx.Panel):
    ...
    def __init__(self, parent, id, path):
        ...
        self.text6 = wx.TextCtrl(self, -1, value='100')
        ...
        self.cb4 = wx.ComboBox(self, -1, value='共轭梯度(CG)法', choices=types3, style=wx.CB_READONLY)
        ...
        relax_box.Add(box_l, flag=wx.ALL, border=5)
        relax_box.Add(box_m, flag=wx.ALL, border=5)
        relax_box.Add(box_r, flag=wx.ALL, border=5)
    ...
    def WriteRelax(self, path):
        if self.relax:

            def relax_folder(path):
                for i in os.listdir(path):
                    ...
                    if os.path.isfile(path1):
                        ...
                        if ext == '.cif':
                            relax_path = os.path.join(os.path.dirname(path1), 'relax')

                            if not os.path.exists(relax_path):
                                os.mkdir(relax_path)
                            with open(os.path.join(relax_path, 'INCAR'), 'a+') as f:
                            ...
                            with open(os.path.join(relax_path, 'KPOINTS'), 'a+') as f:
                            ...
                            shutil.copyfile(os.path.join(os.path.dirname(path1), 'POSCAR'),
                                            os.path.join(relax_path, 'POSCAR'))
                            shutil.copyfile(os.path.join(os.path.dirname(path1), 'POTCAR'),
                                            os.path.join(relax_path, 'POTCAR'))
                    else:
                        relax_folder(path1)
